...
const resolveComponentPath = (element: Element, win: Window) => {
  try {
    const selectionApi =
      win.__ITERA_EMBEDDED_INSPECTOR_SELECTION__ ??
      win.__ITERA_EMBEDDED_REACT_INSPECTOR_SELECTION__ ??
      win.__ARA_EMBEDDED_INSPECTOR_SELECTION__ ??
      win.__ARA_EMBEDDED_REACT_INSPECTOR_SELECTION__;
